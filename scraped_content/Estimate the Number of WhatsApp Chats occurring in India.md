...
*Source: https://www.mypminterview.com/p/estimate-whatsapp-messages-sent-in-india*
...
Q) What is the Time Frame we should consider?

A) Let’s consider, on a Per Day basis.



Q) Does it include both personal and group chats?
...
= Total Populations of India * Internet Penetration * % of Smartphone users * % of users using WhataApp
...
The approximate number of WhatsApp users in India = 300 million



Now, let’s divide the number of WhatsApp users into the following age groups -
...
Also, these age groups can be further divided based on usage,
...
Now, let’s calculate the number of WhatsApp messages sent per day -





WhatsApp messages sent by age groups,

* 10 - 24 yrs old = 70 x (150 M x 0.7) + 40 x (150 M x 0.2) + 20 x (150 M x 0.1) = 8850M
* 25 - 35 yrs old = 50 x (75 M x 0.5) + 20 x (75 M x 0.3) + 10 x (75 M x 0.2) = 2475 M
* 36 - 50 yrs old = 30 x (45 M x 0.3) + 10 x (45 M x 0.5) + 5 x (45 M x 0.2) = 675 M
* 51 - 65 yrs old = 10 x (30 M x 0.1) + 5 x (30 M x 0.3) + 2 x (30 M x 0.6) = 111 M
...
Total number of WhatsApp messages sent per day,

= (8850 + 2475 + 675 + 111) million

= 12,111 million or 12.11 billion.



[Share](https://www.mypminterview.com/p/estimate-whatsapp-messages-sent-in-india?utm_source=substack&utm_medium=email&utm_content=share&action=share)
