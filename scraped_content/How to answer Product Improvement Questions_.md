...
*Source: https://www.mypminterview.com/p/how-to-answer-product-improvement-question*
...
1. How would you improve LinkedIn?
2. How would you improve the retention of LinkedIn Premium?
...
1. Take a minute and write down the question.This will make sure you don’t deviate from the Goal throughout the journey of answering that question. In the end, when you will have to summarize, you need to connect how your proposed solution will solve the problem stated by the interviewer at the beginning.

Take a minute and write down the question.This will make sure you don’t deviate from the Goal throughout the journey of answering that question. In the end, when you will have to summarize, you need to connect how your proposed solution will solve the problem stated by the interviewer at the beginning.

My PM Interview - is a reader-supported publication. To receive new posts and support my work, consider becoming a  paid subscriber.
...
Next, list down the various user segments who use the product along with mentioning some of their unique attributes.Remember: User segments must be distinct from one another and possess distinct attributes.



Again going back to the LinkedIn example, here are a few user groups that use LinkedIn:

* Job Seekers:Uses LinkedIn to find jobs and connect with employment opportunities.Usually browses through companies, and different job listings, and applies for a lot of jobs.
...
### Step 5: List and prioritize the Pain Points for that segment
...
You need to come up with a set of success metrics that would help you measure the impact of the features/changes you’re proposing. You can list them as primary and secondary metrics that you want to measure.
...
[Share](https://www.mypminterview.com/p/how-to-answer-product-improvement-question?utm_source=substack&utm_medium=email&utm_content=share&action=share)
